...
#ifdef ANDROID
	// NOTIMPLEMENTED
	// TODO(jackson): Figure out why this isn't working; will improve performance
	NSLog(@"NSOperationQueue is not working on Android; performing operation synchronously");
	[op main];
	return;
#endif
